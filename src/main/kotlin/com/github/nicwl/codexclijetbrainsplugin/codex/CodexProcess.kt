...
/**
 * Lightweight, non-service process transport for a single Codex session.
 * Duplicates the behavior of CodexProcessService but intended to be used per-tab.
 */
class CodexProcess(private val project: Project) : Disposable {
